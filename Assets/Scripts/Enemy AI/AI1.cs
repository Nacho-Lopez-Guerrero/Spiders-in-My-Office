...
*/
	...
	private void Init()
	{
		...
		_home = transform.parent.transform.parent.transform.parent.transform;
...
//		Debug.LogWarning("Combat: " + _me.inCombat);
		...
		{				
			...
			if(_target.name == "Spawn Point " + _advancedMovement.gameObject.name )
			{
				Debug.Log("Faltan: " + dist + " metros");
